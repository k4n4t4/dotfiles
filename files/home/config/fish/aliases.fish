...
if type -q git
    ...
    abbr --add gcmau  "git add . && git commit"
    abbr --add gcmaup "git add . && git commit && git push"
    abbr --add gu     "git add . && git commit && git push"
...
if type -q eza
    ...
    alias llt  "exa -FTl"
    alias llta "exa -FTla"
    set -gx EXA_COLORS (get_ls_colors exa)
else if type -q lsd
    alias ls   "lsd"
    alias ll   "lsd -Fl"
    alias la   "lsd -Fa"
    ...
    alias la  "ls -Fa"
    alias lla "ls -Fla"
    set -gx LS_COLORS (get_ls_colors)
end
