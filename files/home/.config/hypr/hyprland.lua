...
hl.define_submap("Media", function()
    ...
    hl.bind("up", hl.dsp.exec_cmd("pactl set-sink-volume @DEFAULT_SINK@ +5%"), { repeating = true })
    hl.bind("k", hl.dsp.exec_cmd("pactl set-sink-volume @DEFAULT_SINK@ +5%"), { repeating = true })
    hl.bind("down", hl.dsp.exec_cmd("pactl set-sink-volume @DEFAULT_SINK@ -5%"), { repeating = true })
    hl.bind("j", hl.dsp.exec_cmd("pactl set-sink-volume @DEFAULT_SINK@ -5%"), { repeating = true })
    hl.bind("return", hl.dsp.exec_cmd("pactl set-sink-mute @DEFAULT_SINK@ toggle"))
    hl.bind("SHIFT + up", hl.dsp.exec_cmd("pactl set-source-volume @DEFAULT_SOURCE@ +5%"), { repeating = true })
    hl.bind("SHIFT + k", hl.dsp.exec_cmd("pactl set-source-volume @DEFAULT_SOURCE@ +5%"), { repeating = true })
    hl.bind("SHIFT + down", hl.dsp.exec_cmd("pactl set-source-volume @DEFAULT_SOURCE@ -5%"), { repeating = true })
    hl.bind("SHIFT + j", hl.dsp.exec_cmd("pactl set-source-volume @DEFAULT_SOURCE@ -5%"), { repeating = true })
    hl.bind("SHIFT + return", hl.dsp.exec_cmd("pactl set-source-mute @DEFAULT_SOURCE@ toggle"))
