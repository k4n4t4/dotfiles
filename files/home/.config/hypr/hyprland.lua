...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("uwsm app -- awww img ~/pers/imgs/wallpapers/background.png --transition-type center --transition-duration 1")
...
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd("amixer sset Master 5%+"), { repeating = true })
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd("amixer sset Master 5%-"), { repeating = true })
hl.bind("XF86AudioMute", hl.dsp.exec_cmd("amixer sset Master toggle"))
hl.bind("XF86AudioMicMute", hl.dsp.exec_cmd("amixer sset Capture toggle"))
...
hl.define_submap("Media", function()
    ...
    hl.bind("up", hl.dsp.exec_cmd("amixer sset Master 5%+"), { repeating = true })
    hl.bind("k", hl.dsp.exec_cmd("amixer sset Master 5%+"), { repeating = true })
    hl.bind("down", hl.dsp.exec_cmd("amixer sset Master 5%-"), { repeating = true })
    hl.bind("j", hl.dsp.exec_cmd("amixer sset Master 5%-"), { repeating = true })
    hl.bind("return", hl.dsp.exec_cmd("amixer sset Master toggle"))
    hl.bind("SHIFT + up", hl.dsp.exec_cmd("amixer sset Capture 5%+"), { repeating = true })
    hl.bind("SHIFT + k", hl.dsp.exec_cmd("amixer sset Capture 5%+"), { repeating = true })
    hl.bind("SHIFT + down", hl.dsp.exec_cmd("amixer sset Capture 5%-"), { repeating = true })
    hl.bind("SHIFT + j", hl.dsp.exec_cmd("amixer sset Capture 5%-"), { repeating = true })
    hl.bind("SHIFT + return", hl.dsp.exec_cmd("amixer sset Capture toggle"))
    hl.bind("CTRL + up", hl.dsp.exec_cmd("brightnessctl s +5%"), { repeating = true })
    hl.bind("CTRL + k", hl.dsp.exec_cmd("brightnessctl s +5%"), { repeating = true })
    hl.bind("CTRL + down", hl.dsp.exec_cmd("brightnessctl s 5%-"), { repeating = true })
    hl.bind("CTRL + j", hl.dsp.exec_cmd("brightnessctl s 5%-"), { repeating = true })
    hl.bind("catchall", hl.dsp.submap("reset"))
end)
