return {
    {
        ...
        keys = {
            ...
            { "<Leader>ll", require("plugins.specs.config.snacks.lsp_picker").lsp_picker, desc = "Lsp List (current)" },
            { "<Leader>lL", require("plugins.specs.config.snacks.lsp_picker").lsp_picker_all, desc = "Lsp List" },
