return {
    ...
    keys = {
        ...
        { mode = 'n', '<LEADER>gF',  "<CMD>Lspsaga diagnostic_jump_next<CR>",    desc = "Lspsaga DiagnosticJumpNext" },
        { mode = 'n', '<LEADER>g[',  "<CMD>Lspsaga diagnostic_jump_prev<CR>",    desc = "Lspsaga DiagnosticJumpPrev" },
        { mode = 'n', '<LEADER>gf',  "<CMD>Lspsaga show_cursor_diagnostics<CR>", desc = "Lspsaga ShowCursorDiagnostics" },
