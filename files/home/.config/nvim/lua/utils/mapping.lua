...
--- Vim mode mapping: raw mode string -> { name: short label, label: long label }
...
M.mode = M.new({
    ...
    ["ntT"] = { name = "NTT", label = "N-TERMINAL-T" },
